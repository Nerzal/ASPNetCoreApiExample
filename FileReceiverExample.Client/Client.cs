...
namespace FileReceiverExample.Client {
  /// <summary>
  ...
  public class Client {
    ...
    public void UpsertImage(Image image) {
      ...
      HttpWebRequest httpWebRequest = GetNewRequest($"localhost/api/images/", "POST");
    ...
    public void DeleteImage(string fileName) {
      //TODO use serviceBaseURL, which should point to the dockerInstance
      HttpWebRequest request = GetNewRequest($"localhost/api/images/{fileName}", "DELETE");
